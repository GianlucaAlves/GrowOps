  ...
  return (
    <main className="mx-auto max-w-2xl space-y-4 py-6">
      <section className="rounded-3xl border bg-card p-5 md:p-6">
        ...
        <h2 className="text-2xl font-bold tracking-tight">Registrar rega 💧</h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Registre volume e recorrência para manter consistência no cuidado.
        </p>
      </section>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="flex flex-wrap gap-2">
            {[
              ...
              {
                label: "Manjericão + 200ml",
                planta: "Manjericão",
                quantidade: "200 ml",
              },
              {
                label: "Pimenteira + 250ml",
                planta: "Pimenteira",
                quantidade: "250 ml",
              },
            ].map((preset) => (
              <button
                ...
                type="button"
                onClick={() => {
                  setPlanta(preset.planta);
                  setQuantidade(preset.quantidade);
                }}
